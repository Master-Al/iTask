...
export function sendCreateProduct(data) {
  return dispatch => {
    ...
    return apiUtils
      .callAPI('/api/products', 'POST', data)
...
export function sendUpdateProduct(data) {
  return dispatch => {
    ...
    return apiUtils
      .callAPI(`/api/products/${data._id}`, 'PUT', data)
...
export function sendDelete(id) {
  return dispatch => {
    ...
    return apiUtils
      .callAPI(`/api/products/${id}`, 'DELETE')
...
export const returnProductListPromise = (...listArgs) => (
  dispatch,
  getState,
) => {
  /**
